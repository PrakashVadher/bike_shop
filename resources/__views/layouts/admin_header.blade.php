                    ...
                    <div class="widget-content-left">
                        <div class="btn-group">
                            <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                <img width="42" class="rounded" src="{{asset('/back_end_admin/assets/images/avatars/3.jpg')}}" alt="">
                                                ...
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left mr-3">
                                                        <img width="42" class="rounded-circle"
                                                             src="{{asset('/back_end_admin/assets/images/avatars/3.jpg')}}"
                                                             alt="">
                                                    </div>
                                                    <div class="widget-content-left">
                                                    ...
                                                    <div class="widget-content-right mr-2">
                                                        <a class="btn-pill btn-shadow btn-shine btn btn-focus" href="{{ route('admin.logout')}}">
                                                                Logout
                                                        </a>
