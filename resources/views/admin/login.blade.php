...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Aug 2019 12:07:29 GMT -->
                                    ...
                                    <form method="POST" action="{{ route('admin.loginPost') }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="ml-auto">
                                                ...
                                                <button class="btn btn-primary btn-lg">{{ __('Login To Dashboard') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
